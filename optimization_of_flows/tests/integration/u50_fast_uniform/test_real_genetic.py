...
class TestRealGeneticU50FastUniform(unittest.TestCase):
    def test_real_genetic_end_to_end(self) -> None:
        artifacts = run_case("real_genetic")
        ...
        self.assertLess(report["runtime_sec"], 240.0, report)
