...
from simple_solver_components import (
    AgentState,
...
def solve_sandbox_milp(
    ...
    lengths_all = {src: nx.single_source_dijkstra_path_length(UG, src, weight="distance_km") for src in N}
...
def assign_tasks_greedy(dataset, graph, payload, cache):
    res, routes_df = solve_sandbox_milp(payload)
